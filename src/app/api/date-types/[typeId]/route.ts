...
export async function DELETE(_req: Request, { params }: Params) {
  try {
    ...
    await prisma.importantDateType.delete({ where: { id: typeId } });
    ...
    // bağlı tarih kayıtları varken silme engellenir.
    if (
      typeof error === "object" &&
      error !== null &&
      "code" in error &&
      ...
      return NextResponse.json(
        { error: "Bu türe bağlı tarih kayıtları var, önce onları silin veya türünü değiştirin." },
        { status: 409 },
      );
    }
