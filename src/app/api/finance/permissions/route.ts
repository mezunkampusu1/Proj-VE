...
/**
 * Üye bazlı finans yetki override listesi — yalnızca ADMIN görebilir/yönetebilir
 * (bkz. proje talebi §5). ADMIN rolündeki kullanıcılar listeye dahil edilmez;
...
export async function GET() {
  try {
    ...
    const overrides = await prisma.financePermission.findMany({
