...
import { BlogContentView } from "@/components/content/blog-content-view";
...
export default async function BlogContentPage() {
  ...
  if (!permissions.canViewModule || !permissions.canManageBlog) {
    return (
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      <div>
        <h1 className="text-xl font-semibold text-foreground">Blog &amp; SEO İçerikleri</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          Blog yazılarını, SEO/GEO alanlarını ve yayın sürecini planlayın ve takip edin.
        </p>
      </div>
      <BlogContentView
